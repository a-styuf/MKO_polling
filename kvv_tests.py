...
fast_test = ["Быстрый тест КВВ", [
    ...
    [29, 17, 0, [0x000C, 0x0000, 10000, 100], 4, 42, 42, 0.0, 0.0],
    [29, 17, 0, [0x000C, 0x0001, 20000, 50], 4, 52, 52, 0.0, 0.0],
    [29, 17, 0, [0x000C, 0x0002, 15000, 66], 4, 62, 62, 0.0, 0.0],
    [29, 17, 0, [0x000C, 0x0003, 5000, 200], 4, 72, 72, 0.0, 0.0],
    # Чтение ЗУ ЦМ
...
ib_test = ["Проверка внутренней шины", [
    ...
    # Системный кадр
    [29, 1, 1, [], 32, 15, full_time, 0.5, 0.35],
    # Чтение ЗУ ЦМ
    [29, 18, 0, [0xABBA, 0xACDC, 0x0000, 0x0000], 4, 25, full_time, 0.5, 0.0],
    [29, 20, 1, [0], 32, 25, full_time, 0.5, 0.1],
]]
